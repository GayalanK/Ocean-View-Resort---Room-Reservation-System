...
public class WebServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.oceanview.resort.dao.UserDAO userDAO = new com.oceanview.resort.dao.UserDAO();
            userDAO.findAll();
            System.out.println("User data initialized.");

            com.oceanview.resort.dao.RoomDAO roomDAO = new com.oceanview.resort.dao.RoomDAO();
            roomDAO.findAll();
